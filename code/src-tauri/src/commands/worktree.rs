...
use crate::models::{
    CreateWorktreeParams, FinishHotfixResult, HotfixInfo, StartHotfixParams, StartHotfixResult,
    WorktreeListResponse, WorktreeResult,
};
use crate::services::{
...
/// 在终端中打开
#[command]
pub async fn open_in_terminal_cmd(
    worktree_path: String,
...
/// 在编辑器中打开
#[command]
pub async fn open_in_editor_cmd(
    worktree_path: String,
...
/// 获取分支列表
#[command]
pub async fn list_branches_cmd(
    repo_path: String,
) -> Result<crate::models::BranchListResponse, String> {
    validate_path(&repo_path).map_err(|e| e.to_string())?;
...
/// 获取仓库基本信息
#[command]
pub async fn get_repository_info_cmd(
    repo_path: String,
) -> Result<crate::models::RepositoryInfo, String> {
    validate_path(&repo_path).map_err(|e| e.to_string())?;
...
/// 切换分支
#[command]
pub async fn switch_branch_cmd(
    worktree_path: String,
    branch_name: String,
) -> Result<crate::models::SwitchBranchResult, String> {
    validate_path(&worktree_path).map_err(|e| e.to_string())?;
...
pub async fn create_branch_cmd(
    ...
    validate_path(&worktree_path).map_err(|e| e.to_string())?;
    run_blocking(move || {
        create_and_switch_branch(&worktree_path, &branch_name, base_branch.as_deref())
    })
    .await
}
...
/// 拉取远程分支
#[command]
pub async fn fetch_remote_branch_cmd(
    repo_path: String,
    remote_branch: String,
    local_branch: Option<String>,
) -> Result<crate::models::SwitchBranchResult, String> {
    validate_path(&repo_path).map_err(|e| e.to_string())?;
    run_blocking(move || fetch_and_checkout(&repo_path, &remote_branch, local_branch.as_deref()))
        .await
}

/// 批量删除 worktree
#[command]
pub async fn batch_delete_worktrees_cmd(
    repo_path: String,
...
/// 获取已合并提示
#[command]
pub async fn get_merged_hints_cmd(
    repo_path: String,
    main_branch: String,
) -> Result<Vec<crate::models::WorktreeHint>, String> {
    validate_path(&repo_path).map_err(|e| e.to_string())?;
...
/// 获取陈旧提示
#[command]
pub async fn get_stale_hints_cmd(
    repo_path: String,
    days: i64,
) -> Result<Vec<crate::models::WorktreeHint>, String> {
    validate_path(&repo_path).map_err(|e| e.to_string())?;
...
/// 获取时间线数据
#[command]
pub async fn get_timeline_cmd(
    repo_path: String,
    since: Option<i64>,
    until: Option<i64>,
) -> Result<crate::models::TimelineResponse, String> {
    validate_path(&repo_path).map_err(|e| e.to_string())?;
...
/// 获取远程分支列表
#[command]
pub async fn list_remote_branches_cmd(
    repo_path: String,
) -> Result<crate::models::RemoteBranchListResponse, String> {
    validate_path(&repo_path).map_err(|e| e.to_string())?;
...
/// 完成 Hotfix 流程
#[command]
pub async fn finish_hotfix_cmd(
    repo_path: String,
    push: bool,
) -> Result<FinishHotfixResult, String> {
